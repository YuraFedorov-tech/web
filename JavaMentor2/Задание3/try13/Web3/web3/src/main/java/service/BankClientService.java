...
public class BankClientService {
    ...
    private static Connection getMysqlConnection() {
        try {
            ...
            url.
                    append("jdbc:mysql://localhost:3306/db_example?useUnicode=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC&").        //db type
                       //db name
                    append("user=root&").          //login
                    append("password=123");
              //      append("useUnicode=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC");       //password
