...
public class Main {
    ...
    public static void main(String[] args) throws Exception {
        CustomerServlet customerServlet = new CustomerServlet(); //   /customer
        DailyReportServlet dailyReportServlet = new DailyReportServlet();
        NewDayServlet newDayServlet = new NewDayServlet();    //    /newday
        ProducerServlet producerServlet = new ProducerServlet();//   /producer
